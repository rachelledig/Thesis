...
#precipitation
cftandprecip <- read.csv('/Volumes/RachelExternal/Thesis/Thesis/DataWesternosprey/cft_and_precipdata.csv')
...
pirrfrac <- plot_ly(aei, x = ~yearcount, y = ~irrperc, group =  ~country, color = ~four_regions, 
