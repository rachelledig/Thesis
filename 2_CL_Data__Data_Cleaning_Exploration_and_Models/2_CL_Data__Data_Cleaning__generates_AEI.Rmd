...
- Topographical   
  ...
  - $Ru_c$ - Represented here using the "rugged" data set from rethinking, in which a coeff of ruggedness for each country was assigned. This data was taken from Riley et al. 1999. 
...
#run this separately, otherwise the plotly part doesnt work.
ggplotly()
...
In general, Africa has low levels of irrigated area. Swaziland, Sao Tome and Principe and Mauritius lead here with majority of others falling below the levels of these countries.
...
The East Asian countries are really high in % of irrigated area. The four countries that reach upwards of (roughly) 10% or more of their total area irrigated toward the end of the study period are Vietnam, North Korea, South Korea, and Thailand. Other countries that have high irrfracs are China, Japan and the Philipines. It is expected that irrigaion fraction would be high here due to the amount of rice produced. 
