...
```{r Map fit for all countries, warning=FALSE, message=FALSE}
models <- 
  by_ISO %>%
  mutate(model = map(data, ~update(fit1, newdata = ., seed = 2, file = "/Volumes/RachelExternal/Thesis/Thesis/fits/countrylevel_linear_fits" )))
```
